...
public record OrderItemResponse(
        ...
        @Schema(description = "Name of the product", example = "Laptop Model X")
        String name,

        @Schema(description = "Quantity of this product in the order", example = "2")
        int quantity,

        @Schema(description = "Price of a single unit of the product (in cents or smallest currency unit)", example = "500")
        int price,
