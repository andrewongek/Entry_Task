...
public class AdminOrderController {
    ...
    @PostMapping("/search")
    public ResponseEntity<CustomApiResponse<OrderInvoiceItemListResponse>> getOrderInvoiceItemList (@Valid @RequestBody AdminOrderInvoiceItemListRequest request) {
