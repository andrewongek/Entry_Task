...
public class FavouriteController {
  ...
  public ResponseEntity<CustomApiResponse<ProductListResponse<ProductListing>>>
      getUserFavouriteProductListingList(@Valid @RequestBody ProductListRequest request) {
    log.debug("Request: {}", request);
    ProductListResponse<ProductListing> responseData =
        userFavouriteService.getUserFavouriteProductListingList(request);
  ...
  public ResponseEntity<CustomApiResponse<Void>> setUserFavouriteByProductId(
  ...
  public ResponseEntity<CustomApiResponse<Void>> deleteUserFavouriteByProductId(
      @PathVariable Long productId) {
