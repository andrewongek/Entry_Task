...
public class UserFavouriteService {
  ...
  public void setUserFavouriteByProductId(Long productId) {
    ...
    Optional<UserFavourite> exists =
        userFavouriteRepository.findByUserIdAndProductId(user.getId(), product.getId());
    if (exists.isPresent()) {
  ...
  public void deleteUserFavouriteByProductId(Long productId) {
    ...
    UserFavourite userFavourite =
        userFavouriteRepository
            ...
            .orElseThrow(
                () -> new FavouriteNotFoundException("Product is already not favourited by User"));
