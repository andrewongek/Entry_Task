...
public class CartController {
  ...
  @Operation(
      ...
      description =
          "Handles adding, updating and deleting from the user's cart based on the productId, and quantity")
  @PutMapping()
  public ResponseEntity<CustomApiResponse<Void>> updateProductInCart(
