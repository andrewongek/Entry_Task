...
public class SellerProductController {
  ...
  public ResponseEntity<CustomApiResponse<ProductListResponse<ProductInfo>>>
      getSellerProductInfoList(@Valid @RequestBody ProductListRequest request) {
    ProductListResponse<ProductInfo> responseData =
        productService.getSellerProductInfoList(request);
  ...
  public ResponseEntity<CustomApiResponse<ProductDetailResponse>> getSellerProductDetail(
  ...
  @Operation(
      ...
      description = "Creates a product. The product will belong to the seller.")
  @PostMapping("/products")
  public ResponseEntity<CustomApiResponse<CreateProductResponse>> createProduct(
      @Valid @RequestBody CreateProductRequest request) {
    return ResponseEntity.ok(
        CustomApiResponse.success(
            "Product created", new CreateProductResponse(productService.createProduct(request))));
  }
  ...
  @Operation(
      ...
      description =
          "Creates a product. Updates the name, price, stock, categories and description.")
  @PutMapping("/products/{productId}")
  public ResponseEntity<CustomApiResponse<Void>> updateProductById(
      @Valid @RequestBody UpdateProductRequest request, @PathVariable Long productId) {
