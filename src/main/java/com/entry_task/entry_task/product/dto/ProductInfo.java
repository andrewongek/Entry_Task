...
public record ProductInfo(
        ...
        @Schema(description = "Seller ID who owns the product", example = "100")
        Long sellerId,
        ...
        @Schema(description = "Detailed product description", example = "Latest Apple iPhone with A17 chip")
        String description,
