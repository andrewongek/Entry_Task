...
class UserFavouriteRepositoryTest {
  ...
  @Autowired private UserFavouriteRepository favouriteRepository;
  ...
  void findByUserIdAndProductId_shouldReturnUserFavourite() {
    ...
    Optional<UserFavourite> result =
        favouriteRepository.findByUserIdAndProductId(customer.getId(), product.getId());
  ...
  void findByUserIdAndProductId_userIdNotFound_shouldNotReturnUserFavourite() {
    ...
    Optional<UserFavourite> result =
        favouriteRepository.findByUserIdAndProductId(invalidUserId, product.getId());
  ...
  void findByUserIdAndProductId_productIdNotFound_shouldNotReturnUserFavourite() {
    ...
    Optional<UserFavourite> result =
        favouriteRepository.findByUserIdAndProductId(customer.getId(), invalidProductIdId);
