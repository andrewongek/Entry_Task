...
class CategoryServiceTest {
    ...
    void createCategory_duplicatedCategoryName_shouldThrowCategoryAlreadyExistsException() {
        ...
        // Then
        CategoryAlreadyExistsException ex = assertThrows(CategoryAlreadyExistsException.class, () -> categoryService.createCategory(new CreateCategoryRequest(category.getName())));
    ...
    void deleteCategory_categoryDoesNotExists_shouldThrowCategoryNotFoundException() {
        ...
        // Then
        CategoryNotFoundException ex = assertThrows(CategoryNotFoundException.class, () -> categoryService.deleteCategory(new DeleteCategoryRequest(categoryId)));
    ...
    void loadCategories_allCategoriesIdsValid_shouldReturnCategorySet() {
        ...
        assertEquals(idSet.size(), result.size(), "Resulting category set size should match input ID set");
    ...
    void loadCategories_oneCategoryIdNotFound_shouldThrowCategoryNotFoundException() {
        ...
        // Then
        CategoryNotFoundException ex = assertThrows(CategoryNotFoundException.class, () -> categoryService.loadCategories(idSet));
